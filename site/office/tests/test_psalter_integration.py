...
class TestSixtyDayCyclePsalmAssignment(TestCase):
    ...
    @pytest.mark.xfail(reason="60-day cycle not yet implemented - feature pending")
    def test_sixty_day_cycle_not_implemented(self):
        ...
        # Fail this test to track the unimplemented feature
        raise NotImplementedError("60-day psalter cycle not yet implemented")
