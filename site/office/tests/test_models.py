...
class TestThirtyDayPsalterDay(TestCase):
    ...
    def test_thirty_day_psalter_exists(self):
        ...
        if count == 0:
            self.skipTest("ThirtyDayPsalterDay data not available in test database")
    ...
    def test_retrieve_psalter_day(self):
        ...
        if ThirtyDayPsalterDay.objects.count() == 0:
            self.skipTest("ThirtyDayPsalterDay data not available in test database")
    ...
    def test_psalter_day_has_mp_and_ep_psalms(self):
        ...
        # Skip if no ThirtyDayPsalterDay data exists in database
        count = ThirtyDayPsalterDay.objects.count()
        if count == 0:
            self.skipTest("ThirtyDayPsalterDay data not available in test database")
    ...
    def test_psalm_string_to_list(self):
        ...
        day = ThirtyDayPsalterDay.objects.create(day=999, mp_psalms="1,2,3", ep_psalms="4,5,6")
    ...
    def test_get_mp_psalms(self):
        ...
        day = ThirtyDayPsalterDay.objects.create(day=998, mp_psalms="1,8,19", ep_psalms="23,51")
    ...
    def test_get_ep_psalms(self):
        ...
        day = ThirtyDayPsalterDay.objects.create(day=997, mp_psalms="1,2", ep_psalms="23,27,51")
...
class TestSettingModel(TestCase):
    ...
    def test_setting_update(self):
        ...
        setting = Setting.objects.create(name="test_setting", title="Test Setting", order=1)
    ...
    def test_setting_deletion(self):
        """Delete Setting"""
        setting = Setting.objects.create(name="temp_setting", title="Temporary Setting")
...
class TestSettingOptionModel(TestCase):
    ...
    def test_setting_option_creation(self):
        ...
        setting = Setting.objects.create(name="test_setting", title="Test Setting")

        option = SettingOption.objects.create(
            setting=setting, name="Option 1", value="option1", order=1, abbreviation="A"
        )
    ...
    def test_setting_has_multiple_options(self):
        ...
        setting = Setting.objects.create(name="multi_option_setting", title="Multi Option Setting")

        option1 = SettingOption.objects.create(setting=setting, name="Short", value="short", order=1)
        option2 = SettingOption.objects.create(setting=setting, name="Long", value="long", order=2)
    ...
    def test_cascade_delete_options_with_setting(self):
        ...
        setting = Setting.objects.create(name="cascade_test", title="Cascade Test")
    ...
    def test_setting_option_has_default_abbreviation(self):
        ...
        option = SettingOption.objects.create(setting=setting, name="Default", value="default")
...
class TestSettingDefaultOption(TestCase):
    ...
    def test_first_option_by_order_is_default(self):
        ...
        setting = Setting.objects.create(name="default_test", title="Default Test")
    ...
    def test_retrieve_default_for_setting_name(self):
        ...
        setting = Setting.objects.create(name="psalter_cycle", title="Psalter Cycle")
        ...
        default = SettingOption.objects.filter(setting__name="psalter_cycle").order_by("order").first()
    ...
    def test_setting_with_no_options(self):
        ...
        setting = Setting.objects.create(name="empty_setting", title="Empty Setting")
