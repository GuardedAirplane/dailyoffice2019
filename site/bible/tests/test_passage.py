...
class TestBibleVersions:
    ...
    def test_bible_versions_contains_all_translations(self):
        ...
        for version in expected_versions:
            assert version in BibleVersions.VERSIONS, f"Version {version} should be in VERSIONS"
    ...
    def test_bible_versions_have_name_and_adapter(self):
        ...
        for version_key, version_config in BibleVersions.VERSIONS.items():
            assert "name" in version_config, f"Version {version_key} should have 'name'"
            assert "adapter" in version_config, f"Version {version_key} should have 'adapter'"
            assert version_config["name"], f"Version {version_key} name should not be empty"
            assert version_config["adapter"], f"Version {version_key} adapter should not be None"
