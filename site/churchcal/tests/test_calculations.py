    ...
    def test_easter_always_sunday(self):
        ...
        for year in [1900, 1950, 2000, 2024, 2050, 2100]:
            ...
            assert easter_date.weekday() == 6, \
                f"Easter {year} should be Sunday, got weekday {easter_date.weekday()}"
...
class TestAdventCalculation:
    ...
    def test_advent_always_sunday(self):
        ...
        for year in [2020, 2021, 2022, 2023, 2024, 2025, 2050]:
            ...
            assert advent_date.weekday() == 6, \
                f"Advent {year} should be Sunday, got weekday {advent_date.weekday()}"
    ...
    def test_advent_always_near_st_andrews_day(self):
        ...
        for year in [2020, 2021, 2022, 2023, 2024, 2025]:
            ...
            assert diff <= 3, \
                f"Advent {year} should be within 3 days of Nov 30, got {diff} days difference"

    def test_advent_in_november_or_december(self):
        """Advent can begin in late November or early December."""
        for year in [2020, 2021, 2022, 2023, 2024, 2025, 2050]:
            advent_date = advent(year)
            assert advent_date.month in [11, 12], \
                f"Advent {year} should be in November or December"
...
class TestSeasonDetermination:
    ...
    def test_season_after_pentecost(self):
        """July 15, 2024 should be Season After Pentecost."""
        cal_date = get_calendar_date(date_class(2024, 7, 15))
