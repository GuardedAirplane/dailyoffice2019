...
- [x] T012 [P] Configure Playwright for E2E tests in app/playwright.config.ts (Docker Compose integration, multi-browser, axe-core accessibility)
...
- [x] T039 [P] [US1] E2E test: View Morning Prayer for today in app/tests/e2e/morning-prayer.spec.ts - **✅ 5 PLAYWRIGHT TESTS** (Docker Compose integration - run with `npm run test:e2e`)
- [x] T040 [P] [US1] E2E test: Morning Prayer displays all elements correctly in app/tests/e2e/morning-prayer.spec.ts - **✅ PLAYWRIGHT + AXE-CORE** (Validates 13+ liturgical components per FR-001 with accessibility testing)
...
- [x] T054 [P] [US2] E2E test: View Evening Prayer for today in app/tests/e2e/evening-prayer.spec.ts - **✅ 6 PLAYWRIGHT TESTS** (Docker Compose integration - run with `npm run test:e2e`)
- [x] T055 [P] [US2] E2E test: Verify psalm assignments differ from Morning Prayer in app/tests/e2e/evening-prayer.spec.ts - **✅ PLAYWRIGHT + AXE-CORE** (Validates psalm differences, all liturgical components, evening-specific elements)
...
- [x] T065 [P] [US3] E2E test: View Midday Prayer and verify brief format in app/tests/e2e/midday-prayer.spec.ts - **✅ 7 PLAYWRIGHT TESTS** (Docker Compose integration - validates abbreviated office format)
...
- [x] T078 [P] [US4] E2E test: View Compline and verify Nunc Dimittis in app/tests/e2e/compline.spec.ts - **✅ 8 PLAYWRIGHT TESTS** (Docker Compose integration - validates Nunc Dimittis and night prayer elements)
...
- **E2E Tests**: 8 Playwright tests with Docker Compose (night prayer validation)
...
- [x] T080 [P] [US5] E2E test: Navigate from Morning to Evening Prayer in app/tests/e2e/navigation.spec.ts - **✅ 10 PLAYWRIGHT TESTS** (Docker Compose)
- [x] T081 [P] [US5] E2E test: Navigate from Evening to Midday Prayer in app/tests/e2e/navigation.spec.ts - **✅ COVERED IN PLAYWRIGHT SUITE**
- [x] T082 [P] [US5] E2E test: Navigate from Midday to Compline in app/tests/e2e/navigation.spec.ts - **✅ COVERED IN PLAYWRIGHT SUITE**
...
- [x] T090 [P] [US6] E2E test: View office for future date (2050) in app/tests/e2e/date-navigation.spec.ts ✓ 47 PLAYWRIGHT TESTS (Docker Compose)
- [x] T091 [P] [US6] E2E test: View office for past date (2020) in app/tests/e2e/date-navigation.spec.ts ✓ COVERED IN PLAYWRIGHT SUITE
- [x] T092 [P] [US6] E2E test: Navigate forward/backward by day in app/tests/e2e/date-navigation.spec.ts ✓ COVERED IN PLAYWRIGHT SUITE
...
- [x] T101 [P] [US7] E2E test: View Family Morning Prayer in app/tests/e2e/family-prayer.spec.ts ✓ 57 PLAYWRIGHT TESTS (Docker Compose)
- [x] T102 [P] [US7] E2E test: Family offices appear in secondary navigation in app/tests/e2e/family-prayer.spec.ts ✓ COVERED IN PLAYWRIGHT SUITE
...
- [x] T118a [P] E2E test: Verify all major BCP 2019 feasts (Christmas, Easter, Epiphany, Ascension, Pentecost, Trinity Sunday, All Saints, Ash Wednesday, Palm Sunday, Good Friday) in app/tests/e2e/major-feasts.spec.ts - **✅ 83 PLAYWRIGHT TESTS** (Docker Compose) - covering 10 major feasts, mobile feast calculations, fixed feast consistency, liturgical seasons, navigation
...
- [x] T193 [P] E2E test: Bible Gateway API unavailable (mock) in app/tests/e2e/error-handling.spec.ts ✓ PLAYWRIGHT TESTS (Docker Compose)
- [x] T194 [P] E2E test: Offline mode displays error in app/tests/e2e/error-handling.spec.ts ✓ COVERED IN PLAYWRIGHT SUITE
- [x] T195 [P] E2E test: Retry button works in app/tests/e2e/error-handling.spec.ts ✓ COVERED IN PLAYWRIGHT SUITE
...
- [x] T233 [P] E2E test: Office page load time < 3 seconds in app/tests/e2e/performance.spec.ts ✓ PLAYWRIGHT TESTS (Docker Compose) - SC-001 compliance
