...
// Mock DynamicStorage
const mockGetItem = vi.fn().mockResolvedValue('24');
...
describe('FontSizer.vue', () => {
  ...
  describe('Component Lifecycle', () => {
    it('should call resetFontSize on mount', async () => {
      ...
      wrapper.vm.resetFontSize = resetFontSizeSpy;
      await wrapper.vm.$options.mounted[0].call(wrapper.vm);

      expect(resetFontSizeSpy).toHaveBeenCalled();
    });
  });
});
